...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= base_url('img/' . $setting['slider_image']) ?>" alt="Slider 1" data-aos="fade-down" data-aos-duration="800" data-aos-delay="100">
...
<section class="about-section">
    <div class="container">
        ...
        <p class="about-text" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="900"> <?= esc($setting['tentang_kami_text']) ?></p>
        <div class="about-icons">
            <div>
                <i class="fas fa-utensils" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="900"></i>
                <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="900"> <?= esc($setting['icon1_text']) ?></p>
            </div>
            <div>
                <i class="fas fa-tags" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="900"></i>
                <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="900"> <?= esc($setting['icon2_text']) ?></p>
            </div>
            <div>
                <i class="fas fa-users" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="900"></i>
                <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="900"> <?= esc($setting['icon3_text']) ?></p>
            </div>
            <div>
                <i class="fas fa-star" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="900"></i>
                <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="900"> <?= esc($setting['icon4_text']) ?></p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="produk-card">
                ...
                <div class="produk-body">
                    ...
                    <?php if (session()->get('isLoggedIn')) : ?>
                        <a href="<?= base_url('macam-produk/' . $item['id']) ?>">
                            <button class="produk-btn">Lihat <?= $item['nama']; ?></button>
                        </a>
                    <?php else : ?>
